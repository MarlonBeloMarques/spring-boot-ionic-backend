...
public class ClienteResource {
	...
	public ResponseEntity<Cliente> find(@RequestParam(value="value") String email){ // recebe um valor que é o email
		Cliente obj = service.findByEmail(email); // chama o serviço e retorna o obj
