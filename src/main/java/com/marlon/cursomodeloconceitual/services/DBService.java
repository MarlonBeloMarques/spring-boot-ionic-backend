...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		categoriaRepository.save(Arrays.asList(cat1,cat2, cat3, cat4, cat5, cat6, cat7)); // salva um array de categorias
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "marlon.belohd@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "marlonmarqsbr@gmail.com", "97717262002", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("25563323", "94438393"));
